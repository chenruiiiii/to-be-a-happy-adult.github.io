...
hexo.extend.filter.register('before_generate', () => {
  const defaultConfig = {
    ...
    social: null,
    favicon: '/01-this-img/favicon.png',
    avatar: {
      img: '/01-this-img/butterfly-icon.png',
      effect: false
    },
    ...
    error_img: {
      flink: '/01-this-img/friend_404.gif',
      post_page: '/01-this-img/404.jpg'
    },
    error_404: {
      enable: false,
      subtitle: 'Page Not Found',
      background: '/01-this-img/error-page.png'
    },
    post_meta: {
      page: {
        date_type: 'created',
